...
class Move:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                    ...
                    if self.mouse_pos[Y] >= 50 and self.mouse_pos[Y] <= 1009:
                        ...
                        if dest in self.possible_piece_dest:
                            ...
                            #if promotion
                            if promotion:
                                self.promotion(self.board_array, (dest[X], dest[Y]))
    ...
    def promotion(self, board_array, dest):
        in_promotion = True
        #print the selector
        if self.black_turn:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                    ...
                    if colision(PROMOTION_FRAME, mouse_pos):
                        ...
                        if pos_x == 8:
                            board_array[dest[X]][dest[Y]] = Queen(self.black_turn, self.surface)
                        elif pos_x == 9:
                            board_array[dest[X]][dest[Y]] = Bishop(self.black_turn, self.surface)
                        elif pos_x == 10:
                            board_array[dest[X]][dest[Y]] = Rook(self.black_turn, self.surface)
                        elif pos_x == 11:
                            board_array[dest[X]][dest[Y]] = Knight(self.black_turn, self.surface)
                        in_promotion = False
        pygame.display.update()
